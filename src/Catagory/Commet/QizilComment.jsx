...
const QizilComment = () => {
    ...
    useEffect(() => {
        const fetchreviews = async () => {
            try {
                ...
                const filteredreviews = res.data.filter(review => review.catagory === 'qizil');
    ...
    return (
        <div  className="bg-white dark:border-b relative  dark:bg-black dark:text-white min-h-[700px] text-black overflow-x-hidden">

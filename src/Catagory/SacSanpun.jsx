...
import SacsanpunComment from './Commet/SacsanpunComment';
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allQolbaq.filter(note => note.catagory === 'Sac-Sanpun');

...
import TemizleyiciComment from './Comment/TemizleyiciComment';
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allQolbaq.filter(note => note.catagory === 'Temizleyici');

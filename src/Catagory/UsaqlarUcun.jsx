...
import UsaqlarucunComment from './Comment/UsaqlarucunComment';
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allQolbaq.filter(note => note.catagory === 'Usaq-ucun');

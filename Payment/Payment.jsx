...
const Payment = () => {
  ...
  return (
    <div className="flex justify-between border max-w-7xl dark:to-black mx-auto p-5 gap-5">
      <div className="flex-1 p-5 rounded-lg  dark:to-black shadow-md">
      ...
      <div className="w-80 border p-5 rounded-lg shadow-md">
